...
// SDK planning code. It is only meaningful to compare the "proposed new state"
// produced by Terraform Core with the "planned new state" produced by the
// legacy SDK code via shims.
